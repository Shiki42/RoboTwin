...
def config_signature(config: _config.TrainConfig) -> dict[str, Any]:
    ...
    return {
        ...
        "model": {
            ...
            "spline_field": getattr(model, "spline_field", False),
            "control_horizon": getattr(model, "control_horizon", model.action_horizon),
            "spline_control_points": getattr(model, "spline_control_points", None),
            "spline_degree": getattr(model, "spline_degree", None),
            "spline_regularization": getattr(model, "spline_regularization", None),
        },
