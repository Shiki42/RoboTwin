...
class Args:
    ...
    async_phase_steps: int = 0
    port: int = 8000
    pi0_step: int = 50
    sync_action_chunk_steps: int = 10
    phase_prompt_conditioning: int = 1
    boundary_phase_steps: int = 20
...
def main(args: Args):
    ...
    model = PI0(
        ...
        checkpoint_path,
        args.pi0_step,
        async_phase_steps=args.async_phase_steps,
        sync_action_chunk_steps=args.sync_action_chunk_steps,
        phase_prompt_conditioning=bool(args.phase_prompt_conditioning),
        boundary_phase_steps=args.boundary_phase_steps,
    )
