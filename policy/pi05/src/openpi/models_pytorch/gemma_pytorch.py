...
def _gradient_checkpointing_enabled(
    *,
    expert_enabled: bool,
...
class PaliGemmaWithExpertModel(nn.Module):
    ...
    def forward(
        ...
        if inputs_embeds[1] is None:
            ...
            use_gradient_checkpointing = _gradient_checkpointing_enabled(
                expert_enabled=bool(getattr(self.gemma_expert.model, "gradient_checkpointing", False)),
                wrapper_enabled=bool(getattr(self, "gradient_checkpointing", False)),
