...
def _putcab_casm_config(
    ...
    *,
    ...
    gate_only: bool = False, strict_checkpoint: bool = False,
) -> TrainConfig:
    ...
    return TrainConfig(
        ...
        freeze_filter=nnx.Not(nnx.filterlib.PathContains("phase_gate")) if gate_only else model.get_freeze_filter(),
...
_CONFIGS = [
    ...
    _putcab_casm_config(
        "pi05_putcab_casm_visual_phase_gate_pi05_anchor_gate_only_lora",
        "visual_phase_gate",
        ...
        params_only_checkpoint=False,
        ema_decay=None,
        gate_only=True, strict_checkpoint=True,
    ),
